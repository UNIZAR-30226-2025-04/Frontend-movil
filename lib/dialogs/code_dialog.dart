...
Future<void> showCodeDialog(BuildContext context, String username, int iconId) async {
      ...
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
                ...
                return Container(
                  ...
                  child: Center(
                    child: TextField(
                      ...
                      keyboardType: TextInputType.text, // Set to alphanumeric keyboard
                      ...
                      onChanged: (value) {
                        if (value.isNotEmpty) {
                          ...
                          if (index < 3) {
                            ...
                            FocusScope.of(context).unfocus(); // Hide keyboard after last input
                          }
                        }
                      },
                    ),
            ...
            Row(
              children: [
                Expanded( // Ensures both buttons take the same width

...
class InputFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding( // Padding widget to add padding around the input field
      padding: const EdgeInsets.symmetric(vertical: 6),
      child: Row( // Row widget to organize the elements horizontally
        crossAxisAlignment: CrossAxisAlignment.center, // Align the elements vertically
        children: [
          ...
          SizedBox( // SizedBox widget to set the height and width of the input field
            ...
            child: TextField( // TextField widget to create an input field
              ...
              decoration: InputDecoration( // InputDecoration widget to style the input field
                filled: true,
